  ...
  return (
    <div className="p-6 max-w-4xl mx-auto font-sans">
      ...
      <form className="space-y-4">
        ...
        <input className="w-full border p-2 rounded" type="text" placeholder="Chance %: Home Win" />
        <input className="w-full border p-2 rounded" type="text" placeholder="Chance %: Away Win" />
        <input className="w-full border p-2 rounded" type="text" placeholder="Chance %: Draw" />
